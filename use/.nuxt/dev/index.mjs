...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/devalue/index.js';
import { renderToString } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_ebEFKW = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///mnt/F8E02105E020CC26/vue-projects/nuxt-lms-project/use/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
